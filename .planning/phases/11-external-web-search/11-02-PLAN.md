...
case 'tool-searchExternalProducts': {
  ...
  // Results with summary and cards
  return (
...
Case exists: grep "tool-searchExternalProducts" in message-list.tsx
  ...
  <done>
MessageList handles tool-searchExternalProducts with loading state, no-results state, and external cards rendering
  </done>
</task>
...
- Broken/missing sources: cards should not render (filtered in tool execute)
...
Loading state displays correctly
  ...
  <done>
External web search results display with distinct blue accent styling, clickable source links open in new tabs, loading and empty states work correctly
  </done>
</task>
